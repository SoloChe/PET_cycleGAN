...
do
    ...
    do
        for num_residual_blocks_generator in 6 7 8 9 10
        do
            for discriminator_width in 300 
            do
                for num_residual_blocks_discriminator in 6 7 8 9 10
                do
